...
if (isset($_GET['banned'])) {
    notify('danger', 'You have been blacklisted from accessing the Intelligence Hosting Staff Application System', DOMAIN.'/login');
}
                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="display_name" id="display_name" placeholder="Full Name">
                                    </div>
                                    <div class="form-group">
